  ...
  <div class="add">
    <el-tabs v-model="activeName">
      <el-tab-pane name="first">
        ...
        <el-button type="text" icon="el-icon-back" @click="goBack" class="back-btn">返回题库</el-button>
          ...
          <div class="change essay" v-if="optionValue == '主观题'">
            ...
            <div class="title">
              ...
              <el-input
                type="textarea"
                rows="4"
                v-model="postEssay.scoringCriteria"
                placeholder="请输入评分标准"
                resize="none"
                class="answer"
              >
            ...
            <div class="submit">
              <el-button type="primary" @click="essaySubmit()"
                > 提交修改</el-button
              >
            </div>
          </div>
...
export default {
  ...
  methods: {
        ...
        .then((res) => {
            switch(this.type) {
                ...
                case "填空题":
                    ...
                    break;
                case "主观题":
                    this.postEssay = res.data.data.essayQuestion;
                    break;
            }
        })
        .catch((error) => {});        
    ...
    essaySubmit() {
      //主观题提交
      this.postEssay.questionId = this.questionId;
      this.$axios({
        url: "/api/essay/update",
        method: "put",
        data: {
          ...this.postEssay,
        },
