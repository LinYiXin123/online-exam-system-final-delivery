...
public class JudgeQuestionController {
    ...
    public ApiResult add(@RequestBody JudgeQuestion judgeQuestion, HttpServletRequest request) {
    ...
    public ApiResult edit(@RequestBody JudgeQuestion judgeQuestion, HttpServletRequest request) {
        if (!accessGuard.isTeacherOrAdmin(request)) {
